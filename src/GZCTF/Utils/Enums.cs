...
/// </summary>
[JsonConverter(typeof(JsonStringEnumConverter<GameParticipationMode>))]
public enum GameParticipationMode : byte
{
    /// <summary>
    /// Users join the game as members of a team
    /// </summary>
    Team = 0,

    /// <summary>
    /// Users join the game directly as individual participants
    /// </summary>
    Individual = 1
}
