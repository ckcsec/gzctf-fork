...
public interface ITeamRepository : IRepository
{
    ...
    /// <summary>
    /// Create an internal team used to reuse participation infrastructure for an individual player
    /// </summary>
    public Task<Team> CreateIndividualTeam(UserInfo user, CancellationToken token = default);
