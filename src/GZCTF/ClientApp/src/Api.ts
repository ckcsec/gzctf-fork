...
/** Game participation mode */
export enum GameParticipationMode {
  Team = "Team",
...
export interface GlobalConfig {
  ...
  homeEnterText?: string | null;
  /** Homepage secondary button text */
  homeRegisterText?: string | null;
...
export interface GameInfoModel {
  ...
  /** Whether users participate as teams or individuals */
  participationMode?: GameParticipationMode;
  /**
