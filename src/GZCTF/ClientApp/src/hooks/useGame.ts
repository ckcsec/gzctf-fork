...
import api, { GameParticipationMode, ParticipationStatus } from '@Api'
...
export const toLimitTag = (t: TFunction, limit?: number, mode?: GameParticipationMode) => {
  if (mode === GameParticipationMode.Individual) return t('game.tag.individual')
