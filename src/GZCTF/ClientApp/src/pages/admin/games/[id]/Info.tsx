...
import api, { GameInfoModel, GameParticipationMode } from '@Api'
  ...
  return (
    ...
    >
      <SimpleGrid cols={4}>
        ...
        />
        {(game?.participationMode ?? GameParticipationMode.Team) === GameParticipationMode.Team && (
          <NumberInput
        ...
        <Select
          label={t('admin.content.games.info.participation_mode.label')}
          description={t('admin.content.games.info.participation_mode.description')}
          disabled={disabled}
          value={game?.participationMode ?? GameParticipationMode.Team}
          data={[
            { value: GameParticipationMode.Team, label: t('admin.content.games.info.participation_mode.team') },
            {
              value: GameParticipationMode.Individual,
              label: t('admin.content.games.info.participation_mode.individual'),
            },
          ]}
          onChange={(value) =>
            game && value && setGame({ ...game, participationMode: value as GameParticipationMode })
          }
        />
        <NumberInput
