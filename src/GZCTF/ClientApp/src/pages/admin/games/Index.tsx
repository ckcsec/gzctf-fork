...
import switchClasses from '@Styles/AdminSwitch.module.css'
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        showErrorMsg(e, t)
        setGames({ data: [], length: 0, total: 0 })
        setCurrent(0)
      }
    }
                    ...
                    <Table.Tr key={game.id}>
                      <Table.Td>
                        <Switch
                          ...
                          offLabel="显示"
                          classNames={{
                            track: `${switchClasses.track} ${switchClasses.hiddenTrack}`,
                            thumb: switchClasses.thumb,
                            trackLabel: switchClasses.label,
                          }}
                          disabled={disabled}
                          checked={game.hidden}
