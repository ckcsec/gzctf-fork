...
export const GameCreateModal: FC<GameCreateModalProps> = (props) => {
  ...
  const [participationMode, setParticipationMode] = useState<GameParticipationMode>(GameParticipationMode.Team)
    ...
    <Modal size="30%" title={t('admin.button.games.new')} {...modalProps}>
      <Stack>
        ...
        <Select
          ...
          onChange={(value) => setParticipationMode(value as GameParticipationMode)}
        />
        <DateTimePicker
