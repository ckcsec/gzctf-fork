...
public class GlobalConfig
{
    ...
    /// </summary>
    public const string DefaultDescription = "Cyber Range security competition platform";
    ...
    [CacheFlush(CacheKey.ClientConfig)]
    public string Title { get; set; } = "GZCTF";

    /// <summary>
    /// Platform slogan
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string Slogan { get; set; } = "聚焦攻防实战，锻造网安精英";

    /// <summary>
    /// Homepage main headline. Independent from <see cref="Title" />; empty falls back to the platform name.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeTitle { get; set; }

    /// <summary>
    /// Homepage subtitle. Independent from <see cref="Slogan" />; empty falls back to the platform slogan.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeSubtitle { get; set; }

    /// <summary>
    /// Homepage eyebrow label (e.g. "2026 年度"). Empty falls back to the current year on the client.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeEyebrow { get; set; }

    /// <summary>
    /// Homepage latin badge next to the eyebrow (e.g. "OFFICIAL CTF PLATFORM").
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeBadge { get; set; }

    /// <summary>
    /// Homepage feature cards, one per line in the form "标题|描述". Empty falls back to defaults.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeFeatures { get; set; }

    /// <summary>
    /// Homepage primary button text. Empty falls back to the default on the client.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeEnterText { get; set; }

    /// <summary>
    /// Homepage secondary button text. Empty falls back to the default on the client.
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string? HomeRegisterText { get; set; }
    ...
    public string Platform =>
        string.IsNullOrWhiteSpace(Title) || Title.Equals("GZ", StringComparison.OrdinalIgnoreCase)
            ? "GZCTF"
            : Title;
}
...
public partial class ClientConfig
{
    ...
    /// <summary>
    /// Homepage main headline, independent from the platform name
    /// </summary>
    public string? HomeTitle { get; set; }

    /// <summary>
    /// Homepage subtitle, independent from the platform slogan
    /// </summary>
    public string? HomeSubtitle { get; set; }

    /// <summary>
    /// Homepage eyebrow label
    /// </summary>
    public string? HomeEyebrow { get; set; }

    /// <summary>
    /// Homepage latin badge
    /// </summary>
    public string? HomeBadge { get; set; }

    /// <summary>
    /// Homepage feature cards, one per line as "标题|描述"
    /// </summary>
    public string? HomeFeatures { get; set; }

    /// <summary>
    /// Homepage primary button text
    /// </summary>
    public string? HomeEnterText { get; set; }

    /// <summary>
    /// Homepage secondary button text
    /// </summary>
    public string? HomeRegisterText { get; set; }
    ...
    private static ClientConfig FromConfigs(GlobalConfig globalConfig, ContainerPolicy containerPolicy,
        ...
        new()
        {
            ...
            HomeTitle = globalConfig.HomeTitle,
            HomeSubtitle = globalConfig.HomeSubtitle,
            HomeEyebrow = globalConfig.HomeEyebrow,
            HomeBadge = globalConfig.HomeBadge,
            HomeFeatures = globalConfig.HomeFeatures,
            HomeEnterText = globalConfig.HomeEnterText,
            HomeRegisterText = globalConfig.HomeRegisterText,
